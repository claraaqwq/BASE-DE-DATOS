...
insert into hb_ingrediente values(1002,'huevo',30,'porción');
insert into hb_ingrediente values(1003,'pan',50,'porcion');
insert into hb_ingrediente values(1004,'lechuga',9,'porcion');
insert into hb_ingrediente values(1005,'tomate',8,'kg');
insert into hb_ingrediente values(1006,'queso',10,'kg');
insert into hb_ingrediente values(1007,'pollo',20,'kg');
insert into hb_ingrediente values(1008,'pan rosete',5,'kg');
insert into hb_ingrediente values(1009,'pechuga',7,'kg');
insert into hb_ingrediente values(1010,'jamon',3,'kg');
insert into hb_ingrediente values(1011,'papas al hilo',5,'kg');
insert into hb_ingrediente values(1012,'chorizo',4,'kg');
insert into hb_ingrediente values(1013,'salchicha',6,'kg');
insert into hb_ingrediente values(1014,'milanesa',10,'kg');
insert into hb_ingrediente values(1015,'maiz morado',2,'kg');
insert into hb_ingrediente values(1016,'tosino',10,'kg');
insert into hb_ingrediente values(1017,'Coca Cola 500ml',10,'kg');
insert into hb_ingrediente values(1018,'Inca Cola 500ml',10,'kg');
insert into hb_ingrediente values(1019,'Coca Cola 300ml',10,'kg');
insert into hb_ingrediente values(1020,'Inca Cola 300ml',10,'kg');
insert into hb_ingrediente values(1021,'Agua Cielo',10,'kg');
...
INSERT INTO HB_LOTE VALUES(8,'TOMATE',2,1005,100,'10/03/2023','10/02/2023',300);
